...
import lru.answers.LRUCache
import lru.answers.LRUCache2
import spock.lang.Specification

class LRUCache2WorkshopTest extends Specification {

    def 'empty'() {
        given: 'empty cache'
        def cache = new LRUCache2Workshop<Integer, Integer>(1)
    ...
    def 'get marks entry as a most recently used'() {
        ...
        def cache = new LRUCache2Workshop<Integer, Integer>(2)
    ...
    def 'verify if oldest entries are removed'() {
        ...
        def cache = new LRUCache2Workshop<Integer, Integer>(3)
